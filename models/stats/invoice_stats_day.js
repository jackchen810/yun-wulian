...
const invoiceStatsDaySchema = new mongoose.Schema({
    route_mac:String,
...
invoiceStatsDaySchema.index({doc_del_at: 1}, { expireAfterSeconds:0 } );


const InvoiceDayTable = mongoose.model('InvoiceDayTable', invoiceStatsDaySchema);
module.exports = InvoiceDayTable;